...
Trots att en tidsserie inte anses stationär kan vi ibland med en enkel bearbetning göra serien stationär. I exemplet med Random Walk vet vi att differensen mellan två olika tidssteg endast beror på en slumpmässig dragning från en normalfördelning vilket är oberoende från all annan information. Metoden att skapa denna nya stationära serie kallas för **differentiering** där den enklaste formen består av att beräkna $\nabla Y_t = Y_t - Y_{t-1}$. 
