...
Answerlist
----------
* Backpropagation använder kedjeregeln för att beräkna kostnadfunktionens gradient med avseende på nätverkets vikter och bias.
* Backpropagation uppdaterar automatiskt nätverkets parametrar utan att någon optimeringsalgoritm behövs.
* Vid backpropagation förs derivatorna bakåt från kostnadsfunktionen genom nätverkets olika lager.
* Nätverkets bias påverkar inte kostnadsfunktionen och behöver därför inte ingå i gradientberäkningen.
